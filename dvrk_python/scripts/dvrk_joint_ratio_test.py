...
class example_application:
    ...
    def joint_direct(self):
        ...
        print(rospy.get_caller_id(), ' -> testing direct joint position for 1 joints of ', len(initial_joint_position))
        amplitude = math.radians(40.0) # +/- 10 degrees
        duration = 1  # seconds
    ...
    def set_joint_velocity_ratio(self):
        pub = rospy.Publisher('/dvrk/PSM1/set_joint_velocity_ratio', Float64, queue_size=1)
        rospy.sleep(1)
        pub.publish(1)

    # main method
    def run(self):
        self.set_joint_velocity_ratio()
        self.arm.home()
        self.joint_direct()
        rospy.spin()
